...
public class MainControllerTest {
  ...
  public void setup() throws Exception {
    ...
    mainController.conn = hc;
    mainController.registryUrl = "http://registry:4001/registry/api/v1/registry";
  }
  ...
  void index() {
    ...
    // when
    ResponseEntity<String> resp = mainController.index("Festo_3S7PM0CP4BD");
